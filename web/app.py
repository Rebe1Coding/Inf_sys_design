...
async def get_form_data(mode: str, client_id: Optional[int] = None):
...
# ============= WebSocket для реал-тайм обновлений (опционально) =============
# Можно добавить WebSocket для push-уведомлений от паттерна Наблюдатель
